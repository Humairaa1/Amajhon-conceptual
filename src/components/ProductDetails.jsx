...
const ProductDetails = () => {
    ...
    const {thumbnail, description ,price} =product;

    return (
        <div className="flex items-center justify-center mt-10">
            <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img className="p-8 rounded-t-lg h-48 w-full" src={thumbnail} alt="product image" />
                </a>
                <div className="px-5 pb-5">
                    ...
                    <Link to="/products"><button className="text-white bg-blue-700 hover:bg-blue-800 rounded-lg text-sm px-5 py-2.5 text-center">Back</button></Link>
                    </div>
                </div>
            </div>
        </div>
